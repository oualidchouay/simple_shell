...
void display_env_vars(int *status)
{
	int i;
	char *vars[] = {
	"LESSOPEN", "USER", "GIT_ASKPASS", "SHLVL", "MOTD_SHOWN", "HOME",
	"TERM_PROGRAM_VERSION", "VSCODE_IPC_HOOK_CLI", "VSCODE_GIT_ASKPASS_MAIN",
	"VSCODE_GIT_ASKPASS_NODE", "DBUS_SESSION_BUS_ADDRESS", "COLORTERM",
	"WSL_DISTRO_NAME", "WAYLAND_DISPLAY", "LOGNAME", "NAME",
	"WSL_INTEROP", "PULSE_SERVER", "TERM", "PATH",
	"XDG_RUNTIME_DIR", "DISPLAY", "LANG", "LS_COLORS",
	"VSCODE_GIT_IPC_HANDLE", "TERM_PROGRAM", "SHELL", "LESSCLOSE",
	"VSCODE_GIT_ASKPASS_EXTRA_ARGS", "PWD", "XDG_DATA_DIRS",
